package _myui.player.core
{
   ...
   public class MyPlayerMgr extends EventDispatcher
   {
      ...
      private var _playheadPercentage:Number = 0;  // 播放百分比
      ...
      public function get playheadPercentage():Number { return _playheadPercentage; }
      public function set playheadPercentage(v:Number):void
      {
         if (v < 0 || v > 100) return;
